...
#--------------------------------------------
# Plot 2
Sys.setlocale(category = "LC_ALL", locale = "english") #I'm in France, so the Xlabels where in French

DataPower<- loadData() 
png(filename='plot2.png', width=480, height=480, units='px') 
plot(DataPower$DateTime,DataPower$Global_active_power,ylab='Global Active Power (kilowatts)', xlab='', type='l')
dev.off() 
